import { IBfgGameTableForPlayer } from "../p2p-game-types";
import type { GameRoomModeHostOnlyAccess, GameRoomModeHostPlusP2pAccess } from "../p2p-game-types";
import { adaptToHostedGameRoom } from "../host/adapt-to-hosted-game-room";
import type { PrivatePlayerProfile } from "../../../..";


export const adaptToGameRoomAsHostPlayer = (
  gameRoomUnknown: GameRoomModeHostOnlyAccess | GameRoomModeHostPlusP2pAccess,
  ...
  // const p2pGameRoom = gameRoomUnknown;

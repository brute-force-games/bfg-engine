import { createBfgGameTableForAccessLevelNone, IBfgGameTableForPlayer, type IBfgGameTableForAccessLevelNone } from "./p2p-game-types";
...
export const useGameRoomAsPlayer = (): IBfgGameTableForPlayer | IBfgGameTableForAccessLevelNone => {
  ...
  const gameRoom = adaptToGameRoomAsPlayer(gameRoomUnknown, myPlayerProfile);

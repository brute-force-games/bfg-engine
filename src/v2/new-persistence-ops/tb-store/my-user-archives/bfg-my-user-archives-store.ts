...
import { BfgMyUserArchivesTbSchema } from './bfg-my-user-archives-tb-schemas';
...
// Create the store
export const BfgMyUserArchivesStore = createStore()
  .setTablesSchema(
    schematizer.toTablesSchema(BfgMyUserArchivesTbSchema),
  );
...
//   Object.keys(BfgMyUserArchivesStore.getTable('playerProfiles')).length > 0;

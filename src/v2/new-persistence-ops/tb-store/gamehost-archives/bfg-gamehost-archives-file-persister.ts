...
import { BfgGameHostArchivesStore } from "./bfg-gamehost-archives-store";
...
export const BfgGameHostArchivesFilePersister = createFilePersister(BfgGameHostArchivesStore, "bfg-gamehost-archives.db");

BfgGameHostArchivesFilePersister.startAutoLoad();
BfgGameHostArchivesFilePersister.startAutoSave();

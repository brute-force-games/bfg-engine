...
import { BfgGameHostArchivesStore } from "./gamehost-archives/bfg-gamehost-archives-store";
...
export const saveNewGameTableToTbFile = async (
  ...
  try {
    ...
    BfgGameHostArchivesStore.transaction(() => {
...
export const updateLatestGameTableStepInTbFile = async (
  gameInstanceId: BfgGameInstanceId,
  gameRoomId: BfgGameRoomId,
  gameTableId: BfgGameTableId,
  gameStep: GameStepPersist,
...
export const getLatestGameTableFromTbFile = async (
  gameInstanceId: BfgGameInstanceId,
  gameRoomId: BfgGameRoomId,
  gameTableId: BfgGameTableId,

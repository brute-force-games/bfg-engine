// import { z } from "zod";
// import { GameTableActionSourceSchema, GameTableEventTypeSchema } from "./game-table-event";
...
// export const DbGameTableStepSchema = z.object({
...
//   // stringifiedEvent: BfgEncodedStringSchema,
//   // stringifiedEventOutcome: BfgEncodedStringSchema,
//   // stringifiedNextGameState: BfgEncodedStringSchema,
...
// export type DbGameTableStep = z.infer<typeof DbGameTableStepSchema>;


// export const createDbGameTableStepSchemaForGame = (schemas: BfgGenericEngineMetadataSchemas) => {

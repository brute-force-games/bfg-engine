...
// import { Paper, Stack, Typography, Box, Container } from "../bfg-ui"
...
// export const PlayerGameDetailsComponent = (props: IPlayerBfgGameDetails) => {

//   const { gameMetadata, gameTable, gameActions } = props;

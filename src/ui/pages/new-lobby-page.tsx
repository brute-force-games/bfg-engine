...
import { BfgSupportedGameTitleSchema, BfgSupportedGameTitle } from '~/models/game-box-definition';
  ...
  const handleSubmit = async (formData: CreateLobbyFormData) => {
    try {
      ...
      const getMinAndMaxNumPlayers = (gameTitle: BfgSupportedGameTitle | undefined) => {
        ...
        const gameDefinition = gameRegistry.getGameDefinition(gameTitle);

        console.log('gameDefinition', gameDefinition);

        return {
          minNumPlayers: gameDefinition.minNumPlayersForGame,
          maxNumPlayers: gameDefinition.maxNumPlayersForGame,
        };
      }

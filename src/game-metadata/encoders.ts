...
// export const BfgEncodedStringOrEmptySchema = BfgEncodedStringSchema.or(z.literal(''));
// export type BfgEncodedStringOrEmpty = z.infer<typeof BfgEncodedStringOrEmptySchema>;
...
//         const schemaDesc = schema.description || 'unnamed schema';
//         const message = `Invalid JSON data for schema "${schemaDesc}": ${JSON.stringify(parsedZodObject.error)}`;
//         console.error(message);
//         console.error('Raw encoded string:', encoded);
//         console.error('Parsed object:', parsedObject);
//         return null;
//       }

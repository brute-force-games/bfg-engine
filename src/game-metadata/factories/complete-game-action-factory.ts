...
//   GameActionOutcomeSchema extends typeof BfgGameSpecificGameActionOutcomeSchema,
...
//   outcomeSchema: GameActionOutcomeSchema;
// }
...
// export const createCompleteAllPlayerActionsSchema = (playerActionSchemas: readonly [z.ZodDiscriminatedUnionOption<'actionType'>, ...z.ZodDiscriminatedUnionOption<'actionType'>[]]) => {
//   return z.discriminatedUnion('actionType', playerActionSchemas);
// }

// export type CompleteAllPlayerActionsSchema = ReturnType<typeof createCompleteAllPlayerActionsSchema>;
